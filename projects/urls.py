...
urlpatterns = [
    ...
    path('clasificacionEdad/<int:clasificacion_id>/', ClasificacionEdadView.as_view(), name='clasificacionEdad_detail'),
    path('generos/', GenerosView.as_view(), name='generos'),
    path('generos/<int:genero_id>/', GenerosView.as_view(), name='generos_detail'),
    path('idioma/', IdiomaView.as_view(), name='idioma'),
    path('idioma/<int:idioma_id>/', IdiomaView.as_view(), name='idioma_detail'),
    path('contenido/', ContenidoView.as_view(), name='contenido'),
    path('contenido/<int:contenido_id>/', ContenidoView.as_view(), name='contenido_detail'),
    path('contenido_generos/', ContenidoGenerosView.as_view(), name='contenido_generos'),
    path('contenido_generos/<int:contenido_generos_id>/', ContenidoGenerosView.as_view(), name='contenido_generos_detail'),
    path('subtitulos/', SubtitulosView.as_view(), name='subtitulos'),
    path('subtitulos/<int:subtitulos_id>/', SubtitulosView.as_view(), name='subtitulos_detail'),
    path('peliculas/', PeliculasView.as_view(), name='peliculas'),
    path('peliculas/<int:peliculas_id>/', PeliculasView.as_view(), name='peliculas_detail'),
